  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      try {
        ...
        xhr.open('POST', 'https://alsnema.herokuapp.com/api/Nuevapelicula');
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://alsnema.herokuapp.com/api/Modificapelicula');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://alsnema.herokuapp.com/api/Eliminapelicula');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://alsnema.herokuapp.com/api/seleccionartodos');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://alsnema.herokuapp.com/api/seleccionarporfecha');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://alsnema.herokuapp.com/api/seleccionapelicula');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://alsnema.herokuapp.com/api/seleccionarporid');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://alsnema.herokuapp.com/api/seleccionarpornombre');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
...
function agregaimgdepelicula(imgenbase64, iddeldiv, idpelicula){
  let idConcatenada = "#" + iddeldiv;
  $(idConcatenada).addClass("conPelicula");
  document.getElementById(iddeldiv).innerHTML += "<br><img src='"+imgenbase64+"' width='42px' height='42px' class='imagenes' onclick='abrirtaquilla(\""+idpelicula+"\")'>";
  $(".imagenes").bighover({
    height: "220",
    width: "150"
  });
...
function cargarpeliculadelmes(){
  ...
  clasepeliculainstanciada.peliculaspormesyanno(document.getElementById("mes").value, document.getElementById("actualYear").innerHTML).then(function(response){
    for(var elemento in response){
      ...
      agregaimgdepelicula(response[elemento].IMAGEN,fechadeestapelicula.getDate(), response[elemento]._id);
    }
  }, function(error){
    console.log(error);
  });
}
function abrirtaquilla(id)
        {
